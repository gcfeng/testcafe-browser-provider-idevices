...
var index = {
  ...
  getDevice(browserName) {
    ...
    let device = null; // Auto select device
    ...
    } else if (/iPod/i.test(deviceName)) {
      for (const d of devices) {
